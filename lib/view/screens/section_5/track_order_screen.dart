  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Column(
              children: [
                buildOrderStatus(AppLocalizations.of(context)!.order_received, true, Icons.check_circle),
                buildOrderStatus(AppLocalizations.of(context)!.cooking_your_order, true, Icons.kitchen),
                buildOrderStatus(AppLocalizations.of(context)!.courier_is_picking_up_order, true, Icons.person),
                buildOrderStatus(AppLocalizations.of(context)!.order_delivered, false, Icons.home),
              ],
            ),
            const SizedBox(height: 20),
            ListTile(
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const TrackLocationScreen()),
                  );
                },
      ...
      floatingActionButton: FloatingActionButton(
        backgroundColor: Colors.green,
        onPressed: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => const DeleteCartScreen()));
        },
